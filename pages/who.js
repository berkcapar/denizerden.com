...
const Who = () => {
   ...
   <p className='biotextsecond'>
       ...
       <br/> <p className='paragraph4'> Her iki alanda da çalışmalarına devam eden Deniz, 2018’in Şubat ayında Hideki Kozakura’nın “Barcelona Duo” eserinin Türkiye prömiyerinin ardından, 2019’daTokyo ve Nagoya’da, Türk ve Japon çağdaş bestecilerinin eserlerinin yer aldığı ve Haruyuki Suzuki’nin “Ringlet” eserinin dünya prömiyerini gerçekleştirdiği iki solo resital gerçekleştirdi. </p>
       <br/> <p className='ensemble'>Ayrıca Ensemble Flâneur’ün üyesidir.  </p>
       </p>
